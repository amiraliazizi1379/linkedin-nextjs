...
export default function PostEditOptions({ active }: { active: boolean }) {
  return (
    <div
      className={`absolute flex flex-col items-start right-[30px]  py-1 shadow-md rounded-md transition-all duration-200 w-[300px] text-[14px] 
    ...
    >
      <button
        ...
        className=" flex gap-2 items-center mt-2   cursor-pointer px-2 p-4 hover:bg-gray-100 w-full "
      >

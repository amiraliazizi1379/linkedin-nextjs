...
import { RootState, setEditProfile } from "@/redux/store";
...
export default function PopOp() {
  ...
  return (
    <section className="min-w-[250px] p-2 shadow-md right-[11rem] top-[4.5rem] rounded-md fixed z-20 min-h-[150px] bg-[#fff]">

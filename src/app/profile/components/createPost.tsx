  ...
  return (
    <section className="border-1 border-gray-300 p-2 w-[40vw] mx-auto mt-8 rounded-md bg-[#fff]">
      <article className="flex-center gap-2">
        ...
        <button onClick={() => {setCreatePost(true)}} className="font-semibold text-[13px] text-[#707070] mt-1 py-3 px-4 text-left w-[90%] cursor-pointer hover:bg-[#F1F1F1] rounded-full border-1 border-gray-300">
          Start a post
        </button>
      </article>

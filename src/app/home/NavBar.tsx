...
export default function NavBar() {
  return (
    <nav className=" flex items-center mt-4 max-[1023px]:grid  max-[1023px]:grid-cols-2">
      ...
      <Options datas={data} styles="min-[1023px]:ml-auto max-[449px]:gap-6 max-[449px]:pl-[10rem] max-[1023px]:order-2   overflow-x-auto max-[1023px]:col-start-1 max-[1023px]:col-end-3 max-[1023px]:mt-12 max-[1023px]:gap-[10vw]" noActiveOptions/>
